...
public class Ex04 {
	...
	public static void main(String[] args) {
		...
		System.out.println("0번째 위치의 문자: " + str.charAt(0)); 							//index=0요소 꺼내기
		System.out.println("문자열 연결하기: " + str.concat(" study"));
		System.out.println("av라는 문자열을 포함하는지 확인하기: " + str.contains("av"));			//값 포함하는지 boolean값으로 반환
		System.out.println("va라는 문자열로 끝나는지 확인하기: " + str.endsWith("va"));			//값으로 끝나는지 포함하는지 boolean값으로 반환
		System.out.println("같은 문자열인지 비교하기 : " + str.equals("java"));
		System.out.println("대소문자 상관없이 비교하기 : " + str.equalsIgnoreCase("JAVA"));
		System.out.println("문자v의 위치찾기 : " + str.indexOf('v'));
		System.out.println("문자열길이: " + str.length());
		System.out.println("문자a를 c로 변경 : " + str.replace('a', 'b'));
